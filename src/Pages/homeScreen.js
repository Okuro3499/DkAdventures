    ...
    <div>
        ...
        <Carousel fade>
          <Carousel.Item>
            <img
              ...
              src="https://i.postimg.cc/Wb63b9M9/wade-lambert-f5-CFy6-Fa-C4-unsplash.jpg"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="object-cover h-72 w-full"
              src="https://i.postimg.cc/FKqFnw4K/cedric-dhaenens-CYQSLIAuzz-U-unsplash.jpg"
              alt="Second slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="object-cover h-72 w-full"
              src="https://i.postimg.cc/rsHv82fd/david-clode-nyv-R6wb-U1ho-unsplash.jpg"
              alt="Third slide"
            />
          </Carousel.Item>
        </Carousel>
      ...
      <section className="space-y-6 mb-6">
        <div className="container mx-auto">
          <h2 className="text-xl text-center uppercase drop-shadow">
            welcome to Dk Adventures
          </h2>
          <p className="leading-normal text-sm md:text-base mb-8 text-center md:text-left slide-in-bottom-subtitle">
            Discover Africa with DK Adventures. Our professional multi
            -linguistic Tour Guiders and company staff makes our visitors enjoy
            their expeditions be it game, beach, bird watching, mountain hiking
            expeditions, camping or cultural safaris.
          </p>
        </div>
      </section>
      <hr></hr>

      <section className="mt-6 grid md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-8 container mx-auto">
        <div className="leading-normal text-base md:text-base mb-8 text-center md:text-left slide-in-bottom-subtitle">
          <h4>Reviews</h4>
          <p>
          ...
          <span>Gideon Okuro</span>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <button className="bg-transparent hover:text-red-300 hover:bg-red-500 text-red-700 font-semibold  py-2 px-4 border border-red-500 hover:border-transparent rounded">
                View More
              </button>
            </div>
            <div>
              <button
                className="bg-transparent hover:text-red-300 hover:bg-red-500 text-red-700 font-semibold  py-2 px-4 border border-red-500 hover:border-transparent rounded"
                onClick={handleShow}
              >
                Write a review
              </button>
        ...
        <div className="wpb_column vc_column_container vc_col-sm-6 w-48 -m-2">
            ...
            <div className="wpb_wrapper">
              <div className="wpb_text_column wpb_content_element ">
                <div className="wpb_wrapper">
                  <p>
                    <iframe
                      src="https://www.youtube.com/embed/2rskT-H5-ww?rel=0&amp;modestbranding=1&amp;autohide=1&amp;showinfo=0&amp;controls=0;"
                      width="350"
                      title="tripvideo"
                      height="215"
                      frameBorder="0"
        ...
        {show ? (
          ...
          >
            <div
              ...
              onClick={handleClose}
            >
              <span className="font-bold block text-2xl mb-3">Review</span>
              ...
              <div className="font-semibold">Trip being reviewed(Optional)</div>
              <input
                type="text"
                className="text-md block px-3 py-2 rounded-lg w-72 bg-white border-2 border-gray-300 placeholder-gray-300 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                placeholder="Trip..."
              ...
              <input
                type="text"
                className="text-md block px-6 py-10 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-300 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                placeholder="Comment"
              />
      ...
      <section className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8 justify-items-center">
        <div className="w-80 h-full relative">
          <div className="bg-white py-1 px-4 border-2 rounded-md h-full shadow-lg">
            <h5 className="text-lg font-semibold mt-1">Hell's Gate</h5>
            ...
            <p className="text-base text-center mt-1">
              ...
              lying in a catchment of faulted volc..
            </p>
          </div>
        </div>
        <div className="w-80 h-full relative">
      ...
      <section className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8 justify-items-center">
        ...
        <div>
          <img
            alt="map"
            className="object-contain h-48 w-full mt-2"
            src="https://via.placeholder.com/268x192?text=NO+MAP"
          />
        </div>
        <div>
          <ul>
            <span className="uppercase">connect with us </span>
            <li>info@DKadventures.com</li>
            <li>Call: (+254) 719-240-756</li>
          </ul>
          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-2 gap-y-2 place-items-center">
            <svg
