...
function Shop() {
  return (
    <div>
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 sm:col-span-12 md:col-span-7 lg:col-span-8 xxl:col-span-8">
            <section className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8 justify-center">
              <div className="bg-white py-1 px-4 border-2 rounded-md h-full shadow-lg">
                <img
                  alt="shirt"
                  className="object-contain h-48 w-full mt-2"
                  src={
                    "https://i.postimg.cc/bw0HzwTK/DK-004.jpg" ||
                    "https://via.placeholder.com/268x192?text=NO+IMAGE"
                  }
                />
                <span className="text-sm font-regular items-center text-center mt-1">
                  White & red Shirt
                </span>
                <button className="bg-transparent text-sm hover:text-red-300 text-red-700 font-regular py-1 px-2 border border-blue-500 hover:border-transparent rounded-full">
                  Add to cart
                </button>
              </div>
              ...
              <div className="bg-white py-1 px-4 border-2 rounded-md h-full shadow-lg">
                <img
                  ...
                  className="object-contain h-48 w-full mt-2"
                  src={
                    "https://i.postimg.cc/hjvBwVKP/DK-001-1.jpg" ||
                    "https://via.placeholder.com/268x192?text=NO+IMAGE"
                  }
                />
                <span className="text-sm font-regular items-center text-center mt-1">
                ...
                <button className="bg-transparent text-sm hover:text-red-300 hover:bg-red-500 text-red-700 0  font-regular py-1 px-2 border border-blue-500 hover:border-transparent rounded-full">
                  Add to cart
                </button>
              </div>
              <div className="bg-white py-1 px-4 border-2 rounded-md h-full shadow-lg">
                <img
                  ...
                  className="object-contain h-48 w-full mt-2"
                  src={
                    "https://i.postimg.cc/jdcrs8Cd/DK-002.jpg" ||
                    "https://via.placeholder.com/268x192?text=NO+IMAGE"
                  }
                />
                <span className="text-sm font-regular items-center text-center mt-1">
              ...
              <div className="bg-white py-1 px-4 border-2 rounded-md h-full shadow-lg">
                <img
                  ...
                  className="object-contain h-48 w-full mt-2"
                  src={
                    "https://i.postimg.cc/NFP7Dqpj/DK-003.jpg" ||
                    "https://via.placeholder.com/268x192?text=NO+IMAGE"
                  }
                />
                <span className="text-sm font-regular items-center text-center mt-1">
      ...
      {/* src="https://i.postimg.cc/hjvBwVKP/DK-001-1.jpg" */}
      {/* src="https://i.postimg.cc/jdcrs8Cd/DK-002.jpg" */}
      {/* src="https://i.postimg.cc/NFP7Dqpj/DK-003.jpg" */}
      {/* src="https://i.postimg.cc/bw0HzwTK/DK-004.jpg" */}
    </div>
  );
}
